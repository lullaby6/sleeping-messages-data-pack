...
execute if entity @s[tag=sleeping_messages.player.sleeping] if score @s sleeping_messages.player.sleep_timer matches 0 run tag @s remove sleeping_messages.player.sleeping